...
#if defined(_MSC_VER) && (_MSC_VER < 4500)
typedef int                BOOL;
#else
typedef bool               BOOL;
#endif
...
#define I8_FITS_IN_RANGE(n) ((I8_MIN <= (n)) && ((n) <= I8_MAX) ? TRUE : FALSE)
#define U8_FITS_IN_RANGE(n) ((U8_MIN <= (n)) && ((n) <= U8_MAX) ? TRUE : FALSE)
#define I16_FITS_IN_RANGE(n) ((I16_MIN <= (n)) && ((n) <= I16_MAX) ? TRUE : FALSE)
#define U16_FITS_IN_RANGE(n) ((U16_MIN <= (n)) && ((n) <= U16_MAX) ? TRUE : FALSE)
#define I32_FITS_IN_RANGE(n) ((I32_MIN <= (n)) && ((n) <= I32_MAX) ? TRUE : FALSE)
#define U32_FITS_IN_RANGE(n) ((U32_MIN <= (n)) && ((n) <= U32_MAX) ? TRUE : FALSE)
