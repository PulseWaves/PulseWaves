****************************************************************
  ...
  sorts the pulse records in a PulseWaves file by their GPS time
  stamp.
...
>> pulsesort.exe 
>> pulsesort.exe -version
>> pulsesort.exe -i lidar.pls -gui
>> pulsesort.exe -i lidar.plz -gui
>> pulsesort.exe -i lidar.pls -o lidar_sorted.plz
>> pulsesort.exe -i lidar.plz -o lidar_sorted.pls

for more info:

D:\PulseTools\bin>pulsesort -h
...
usage:
pulsesort -i in.pls -o out_sorted.plz
pulsesort -i in.plz -o out_sorted.pls
pulsesort -i in.pls -gui
pulsesort -i lines*.pls -odix _sorted -oplz
pulsesort -version
pulsesort -h
