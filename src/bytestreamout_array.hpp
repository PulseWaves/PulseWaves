...
===============================================================================
*/
#ifndef BYTE_STREAM_OUT_ARRAY_H
#define BYTE_STREAM_OUT_ARRAY_H
...
inline void ByteStreamOutArray::putByte(U8 byte)
{
  if (curr == alloc)
  {
    alloc += 1024;
...
inline void ByteStreamOutArray::putBytes(const U8* bytes, U32 num_bytes)
{
...
inline void ByteStreamOutArrayLE::put16bitsLE(const U8* bytes)
{
  putBytes(bytes, 2);
}

inline void ByteStreamOutArrayLE::put32bitsLE(const U8* bytes)
{
  putBytes(bytes, 4);
}

inline void ByteStreamOutArrayLE::put64bitsLE(const U8* bytes)
{
  putBytes(bytes, 8);
}

inline void ByteStreamOutArrayLE::put16bitsBE(const U8* bytes)
{
  swapped[0] = bytes[1];
  swapped[1] = bytes[0];
  putBytes(swapped, 2);
...
inline void ByteStreamOutArrayLE::put32bitsBE(const U8* bytes)
{
  swapped[0] = bytes[3];
  swapped[1] = bytes[2];
  swapped[2] = bytes[1];
...
inline void ByteStreamOutArrayLE::put64bitsBE(const U8* bytes)
{
  swapped[0] = bytes[7];
  swapped[1] = bytes[6];
  swapped[2] = bytes[5];
...
inline void ByteStreamOutArrayBE::put16bitsLE(const U8* bytes)
{
  swapped[0] = bytes[1];
  swapped[1] = bytes[0];
  putBytes(swapped, 2);
...
inline void ByteStreamOutArrayBE::put32bitsLE(const U8* bytes)
{
  swapped[0] = bytes[3];
  swapped[1] = bytes[2];
  swapped[2] = bytes[1];
...
inline void ByteStreamOutArrayBE::put64bitsLE(const U8* bytes)
{
  swapped[0] = bytes[7];
  swapped[1] = bytes[6];
  swapped[2] = bytes[5];
...
inline void ByteStreamOutArrayBE::put16bitsBE(const U8* bytes)
{
  putBytes(bytes, 2);
}

inline void ByteStreamOutArrayBE::put32bitsBE(const U8* bytes)
{
  putBytes(bytes, 4);
}

inline void ByteStreamOutArrayBE::put64bitsBE(const U8* bytes)
{
  putBytes(bytes, 8);
}
