...
public:
  ...
  IntegerCompressor(EntropyEncoder* enc, U32 bits, U32 contexts=1, U32 bits_high=8, U32 range=0);
  IntegerCompressor(EntropyDecoder* dec, U32 bits, U32 contexts=1, U32 bits_high=8, U32 range=0);
  ~IntegerCompressor();
