...
public:
/* write single bits                                         */
  inline void putBits(U32 bits, U32 num_bits)
  {
    U64 new_bits = bits;
...
/* write a single byte                                       */
  virtual void putByte(U8 byte) = 0;
/* write an array of bytes                                   */
  virtual void putBytes(const U8* bytes, U32 num_bytes) = 0;
/* write 16 bit low-endian field                             */
  virtual void put16bitsLE(const U8* bytes) = 0;
/* write 32 bit low-endian field                             */
  virtual void put32bitsLE(const U8* bytes) = 0;
/* write 64 bit low-endian field                             */
  virtual void put64bitsLE(const U8* bytes) = 0;
/* write 16 bit big-endian field                             */
  virtual void put16bitsBE(const U8* bytes) = 0;
/* write 32 bit big-endian field                             */
  virtual void put32bitsBE(const U8* bytes) = 0;
/* write 64 bit big-endian field                             */
  virtual void put64bitsBE(const U8* bytes) = 0;
