...
inline void ByteStreamOutNil::putByte(U8 byte)
{
  num_bytes++;
}

inline void ByteStreamOutNil::putBytes(const U8* bytes, U32 num_bytes)
{
  this->num_bytes += num_bytes;
}

inline void ByteStreamOutNil::put16bitsLE(const U8* bytes)
{
  putBytes(bytes, 2);
}

inline void ByteStreamOutNil::put32bitsLE(const U8* bytes)
{
  putBytes(bytes, 4);
}

inline void ByteStreamOutNil::put64bitsLE(const U8* bytes)
{
  putBytes(bytes, 8);
}

inline void ByteStreamOutNil::put16bitsBE(const U8* bytes)
{
  putBytes(bytes, 2);
}

inline void ByteStreamOutNil::put32bitsBE(const U8* bytes)
{
  putBytes(bytes, 4);
}

inline void ByteStreamOutNil::put64bitsBE(const U8* bytes)
{
  putBytes(bytes, 8);
}
